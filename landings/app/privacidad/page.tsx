  ...
  return (
    <main className="legal-page shell">
      ...
      <article className="legal-content">
        ...
        <p>Usamos esta información para revisar el encaje, contactarte por WhatsApp o correo electrónico, preparar una conversación comercial y dar seguimiento a tu solicitud. No vendemos tus datos.</p>
